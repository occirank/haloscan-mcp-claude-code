...
export function configureHaloscanServer(server: McpServer) {
  ...
  server.tool(
    ...
    getDomainsHistoryPositions.shape,
    async (params: DomainsToolsParamsList) => {
      try {
        const data = await makeHaloscanRequest(
          "/domains/history",
  ...
  server.tool(
    ...
    getDomainsCompetitorsBestPages.shape,
    async (params: DomainsToolsParamsList) => {
      try {
        const data = await makeHaloscanRequest(
  ...
  server.tool(
    ...
    async (params: z.infer<typeof getDomainsExpiredReveal>) => {
      try {
        const data = await makeHaloscanRequest(
          "/domains/expired/reveal",
          params,
  ...
  server.tool(
    ...
    async (params: z.infer<typeof getDomainsGmbBacklinksMap>) => {
      try {
        const data = await makeHaloscanRequest(
  ...
  server.tool(
    ...
    async (params: z.infer<typeof getDomainsGmbBacklinksCategories>) => {
      try {
        const data = await makeHaloscanRequest(
